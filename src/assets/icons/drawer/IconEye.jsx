...
const IconEye = ({ fill = "#989BAC", ...props }) => (
  <svg
    width={18}
    height={18}
    viewBox="0 0 18 18"
  ...
  >
    ...
    />
    <path
      d="M8.9998 6.85498C7.8223 6.85498 6.8623 7.81498 6.8623 8.99998C6.8623 10.1775 7.8223 11.1375 8.9998 11.1375C10.1773 11.1375 11.1448 10.1775 11.1448 8.99998C11.1448 7.82248 10.1773 6.85498 8.9998 6.85498Z"
      fill={fill}
      className="group-hover:fill-white transition-all"
    />
  </svg>
